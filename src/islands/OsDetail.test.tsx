...
const view: OsDetailView = {
  ...
  colors: [
    { hex: "#008080", name: "Teal", index: "3", note: "default", isDefault: true, rgb: "0, 128, 128", hsl: "180° 100% 25%", cmyk: "100% 0% 0% 50%", onColor: "#ffffff", family: "teal", tone: "dark", shade: "deep", score: 0, scoreLabel: "< 1k", ral: { code: "RAL 5021", name: "Water Blue", hex: "#07737a" }, ralDesign: { code: "RAL 190 40 20", name: "Deep Sea", hex: "#0d7c7d" }, similar: [{ hex: "#4e9a9a", name: "Teal", osSlug: "kde-1", osName: "KDE 1", match: 88, onColor: "#ffffff", href: "/os/kde-1/4e9a9a" }], firstUse: { slug: "cde", name: "CDE", year: 1993, self: false, href: "/os/cde" } },
    { hex: "#000080", name: "Navy", index: "1", note: "cool", isDefault: false, rgb: "0, 0, 128", hsl: "240° 100% 25%", cmyk: "100% 100% 0% 50%", onColor: "#ffffff", family: "blue", tone: "dark", shade: "deep", score: 0, scoreLabel: "< 1k", ral: { code: "RAL 5002", name: "Ultramarine", hex: "#20214f" }, ralDesign: { code: "RAL 280 20 30", name: "Ink Blue", hex: "#1e2159" }, similar: [], firstUse: { slug: "windows-95", name: "Windows 95", year: 1995, self: true, href: "/os/windows-95" } },
  ],
