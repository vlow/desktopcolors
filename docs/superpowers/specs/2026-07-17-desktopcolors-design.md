...
- **Closest RAL** classic color — nearest of the **full RAL Classic set (216 colors, vendored** from an
...
- (Resolved) Nearest-color matching uses the full 216-color RAL Classic table (vendored) with OKLab distance.
